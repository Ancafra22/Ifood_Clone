...
public class ProdutoAdapterEmpresa extends RecyclerView.Adapter<ProdutoAdapterEmpresa.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(Double.parseDouble(produto.getValorAntigo()) > 0){
            holder.text_valor_antigo.setText(context.getString(R.string.text_valor, GetMask.getValor(Double.parseDouble(produto.getValorAntigo()))));
        }else {
